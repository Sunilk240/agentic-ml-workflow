...
def get_dataset_path():
    ...
    print("📁 **Dataset Selection (Gemini Version)**")
    print("Options:")
...
def main():
    """Main execution function for Gemini version"""
    
    print("🤖 **Gemini ML Assistant Starting...**")
    ...
    try:
        ...
        # Create Gemini agent
        agent_executor = create_agent_executor_gemini(filename)

        print("\n🤖 **Gemini ML Assistant Ready!**")
        ...
        while True:
            ...
            if user_input.strip().lower() in ['exit', 'quit', 'bye']:
                print("👋 Thanks for using the Gemini ML Assistant!")
                break
            ...
            try:
                ...
                print(f"\n🤖 **Gemini Assistant:** {result['output']}")
